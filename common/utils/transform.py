...
class TextTransform:
    ...
    def __init__(
        self,
        sp_model_path="/app/Talking_Head_Generation/src/common/utils/spm/unigram/unigram5000.model",
        dict_path="/app/Talking_Head_Generation/src/common/utils/spm/unigram/unigram5000_units.txt",
    ):
